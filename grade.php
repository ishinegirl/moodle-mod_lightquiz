...
/**
 * Redirects the user to either a lightquiz or to the lightquiz statistics
 *
...
$PAGE->set_url('/mod/lightquiz/grade.php', array('id'=>$cm->id));

if (has_capability('mod/lightquiz:manageattempts', context_module::instance($cm->id))) {
