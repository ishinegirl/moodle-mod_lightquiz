...
$string['modulename'] = 'Lightquiz';
$string['modulenameplural'] = 'Lightquiz Activities';
$string['modulename_help'] = 'Use the Lightquiz Activity module to allow your students to use Englosh Central from within Moodle Courses';
$string['lightquizfieldset'] = 'Custom example fieldset';
$string['lightquizname'] = 'Activity Name';
$string['lightquizname_help'] = 'This is the content of the help tooltip associated with the lightquizname field. Markdown syntax is supported.';
$string['lightquiz'] = 'Lightquiz';
$string['pluginadministration'] = 'Lightquiz Module Administration';
$string['pluginname'] = 'Lightquiz Activity';
...
$string['mediatitle'] = 'Video Title';
$string['mediaid'] = 'Video ID';
$string['lightquizsettings'] = 'Enter Lightquiz Video Title and ID';
$string['lightquiz:addinstance'] = 'Add a new Lightquiz activity';
$string['lightquiz:view'] = 'View Lightquiz activity';
//tabs
$string['overview'] ='Overview';
$string['overview_help'] ='Overview Help';
$string['preview'] ='Preview';
$string['previewlightquiz'] ='Preview Lightquiz';
$string['view'] ='View';
//reports
...
$string['answerid'] ='Phoneme';
$string['wascorrect'] ='Good Count';
$string['chosenanswer'] ='Bad Count';
$string['total'] ='Total';
$string['status'] ='Status';
$string['item'] ='Item';
$string['value'] ='Value';
...
$string['answeridsheader'] = '{$a->lightquizname} Phonemes for {$a->username} attempt on {$a->attemptdate}';
$string['attemptdetailsheader'] = '{$a->name} attempt details for {$a->username} on {$a->date}';
$string['field001'] ='Watch mode';
$string['field002'] ='Speak mode';
$string['field005'] ='Speak Lite mode';
$string['field003'] ='Learn mode';
$string['field006'] ='Lightbox mode';
$string['field004'] ='Hidden challenge';
$string['field007'] ='Simple UI';
...
$string['data006'] ='Lines Watched';
$string['data005'] ='Lines Recorded';
...
$string['data003'] ='Total Active Time';
